        ...
        <div className="bg-white rounded-lg shadow-lg  sm:p-6 relative border max-w-xs sm:max-w-sm lg:max-w-md mx-auto flex flex-col h-full">
            ...
            <img className="object-cover w-full h-full" src={image} alt="Product" />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <Link to={`/product/${_id}`}> <button className="bg-white text-gray-900 py-2 px-4 sm:py-2.5 sm:px-6 rounded-full font-bold hover:bg-gray-300">View Product</button></Link>
                </div>
            </div>
            <div className="flex flex-col flex-grow mt-4">
                ...
                <div className="mt-auto flex flex-col sm:flex-row items-start sm:items-center justify-between  border-t  pt-2 sm:pt-0">
                    <span className="text-gray-900 font-bold text-base sm:text-lg">{price}</span>
                    <button className="bg-gray-900 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 mt-2 sm:mt-0 sm:ml-4 w-full sm:w-auto ">Add to Cart</button>
                </div>
            </div>
        </div>
    );
